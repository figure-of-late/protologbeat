...
`${GOPATH}/src/github.com/mmguero-dev/protologbeat`
...
```
git remote set-url origin https://github.com/mmguero-dev/protologbeat
...
```
mkdir -p ${GOPATH}/src/github.com/mmguero-dev/protologbeat
git clone https://github.com/mmguero-dev/protologbeat ${GOPATH}/src/github.com/mmguero-dev/protologbeat
```

...
```
git remote set-url origin https://github.com/mmguero/protologbeat
...
```
mkdir -p ${GOPATH}/github.com/mmguero
cd ${GOPATH}/github.com/mmguero
git clone https://github.com/mmguero/protologbeat
```
